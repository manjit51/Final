...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		if(Objects.nonNull(curProject) && curProject.getProjectId().equals(input)) {
			curProject = null;
		}
	}
	...
	private void updateProjectDetails() {
		if(curProject == null) {
			...
			BigDecimal actualHours = getDecimalInput("Enter the eactual hours [" + curProject.getActualHours() + "]");
